package com.example.structural.composite.bean;
    ...
    public void init(){
        if(this.file.isDirectory()){
            for(File childF : this.file.listFiles()){
                children.add(childF.isDirectory() ? new Directory(childF.getPath()) : new com.example.structural.composite.bean.File(childF.getPath()));
            }
        }
    }
